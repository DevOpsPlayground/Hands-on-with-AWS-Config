...
def evaluate_compliance(configuration_item, rule_parameters):
    ...
    try:
        ...
        print("Exception:" + str(e) + "\nFunction: " +
              configuration_item['configuration']['functionName'])
        raise
...
def is_a_role_inline_policy_allow_logging(roleName, inlinepolicies):
    ...
    for policy in inlinepolicies:
        getrolepolicy = IAM_CLIENT.get_role_policy(
            RoleName=roleName, PolicyName=policy)
...
def is_a_role_managed_policy_allow_logging(managedpolicies):
    ...
    for policy in managedpolicies:
        ...
        getpolicyversion = IAM_CLIENT.get_policy_version(
            PolicyArn=policy['PolicyArn'], VersionId=getrolepolicy['Policy']['DefaultVersionId'])
